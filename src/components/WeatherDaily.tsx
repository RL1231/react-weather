...
export default function WeatherDaily() {
  ...
  return (
    <div className="mt-4 mb-12 flex flex-col rounded border-2 border-white p-4 font-semibold md:text-2xl lg:mb-8 lg:border-4 lg:p-8 lg:text-4xl xl:mt-0 xl:border-2 xl:text-lg">
      ...
      <ul>
        {forecast?.forecastday.map((d, index) => (
          ...
          >
            <div className="my-auto min-w-15.5 text-left md:min-w-30 lg:min-w-40 xl:min-w-24">
              {index === 0
                ? 'Today'
            ...
            <div>
              <img
                ...
                className="ml-4 h-8 w-8 md:h-12 md:w-12 xl:mr-16 xl:ml-4 xl:h-8 xl:w-8"
              />
            </div>
